...
export const GET_USER_POSTS: ActionTypeProps = createConst("GET_USER_POSTS")
export const GET_USER_FEED: ActionTypeProps = createConst("GET_USER_FEED")
...
export const SAVE_POST: ActionTypeProps = createConst("SAVE_POST")
export const UNSAVE_POST: ActionTypeProps = createConst("UNLIKE_POST")
